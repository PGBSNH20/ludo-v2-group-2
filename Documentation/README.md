...
I made a seperate file to explain more about it, because it is alot of different components that took to make this [Page](https://github.com/PGBSNH20/ludo-v2-group-2/blob/main/Documentation/Razor%20Pages:%20Play!.md)
