...
namespace LudoApi
{
    public class Startup
    {
        ...
        {
            services
                .AddDbContext<LudoContext>()
                .AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("LudoDatabase")));
            services
                .AddControllers()
                .AddNewtonsoftJson();
